...
CREATE TABLE "coffee"(
  ...
  "caractéristique" VARCHAR(64),
  "Disponible" BOOLEAN NOT NULL,
  "date" TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

INSERT INTO "coffee"("name", "description", "reference", "origine", "prix", "caractéristique", "Disponible") 
VALUES 
...
('Kenyan AA','Café corsé avec des nuances chocolatées et une pointe d''épice.',295432730,'Kenya',23.70, 'Acide', true ),
